    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><Link className="dropdown-item" to="/pdfreport">Products Report - PDF</Link></li>
            <li><hr className="dropdown-divider"/></li>
            <li><Link className="dropdown-item" to="/salesbarchart">Annual Sales - Bar Chart</Link></li>
            <li><Link className="dropdown-item" to="/salespiechart">Annual Sales - Pie Chart</Link></li>
          </ul>
        </li>
    ...
    <div className="offcanvas-body">
      ...
      <ul className="nav flex-column">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li data-bs-dismiss="offcanvas">
              <Link className="dropdown-item" to="/pdfreport">Products Report - PDF</Link></li>
            <li><hr className="dropdown-divider"/></li>
            <li data-bs-dismiss="offcanvas">
              <Link className="dropdown-item" to="/salesbarchar">Annual Sales - Bar Chart</Link></li>
            <li data-bs-dismiss="offcanvas">
              <Link className="dropdown-item" to="/salespiechart">Annual Sales - Pie Chart</Link></li>
          </ul>
        </li>
        <li><hr/></li>
